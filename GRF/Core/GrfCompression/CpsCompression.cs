		...
		protected void _init() {
			...
			if (_hModule == IntPtr.Zero) {
				if (Wow.Is64BitProcess) {
					...
					ErrorHandler.HandleException(GrfExceptions.__CompressionDllFailed2.Display(ResourceName, "Microsoft Visual C++ 2010 (x86) | downloading the x64 version will not be compatible"));
				}
